...
public class WeatherContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.dario.tiempo";

    // Create the base of all URI's which apps will use to contact the content provider
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    // Possible paths
    // content://com.dario.tiempo/weather is a valid path for get the weather data
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // what will be sent to openweathermap
